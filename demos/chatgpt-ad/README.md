...
A 27.6-second, 1920x1080\@30fps HyperFrames film made through Sequences using
Codex and the pinned HyperFrames skills. Its direction follows an OpenAI launch
reference studied during production. It passes the pinned strict gate with zero
