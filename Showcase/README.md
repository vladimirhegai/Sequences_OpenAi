...
Five films made by Sequences, packaged for website playback and
implementation-agent reference. Every showcase uses the same contract.
...
The final MP4 declared by each manifest is the website-ready version. `source/`
is the directory an implementation agent should study or execute. The manifest
provides stable machine-readable paths and media metadata.
...
| [Sequences abstract ad](sequences-abstract-ad/README.md)          | HyperFrames · 30.3s · 1920×1080 · 30fps | [final.mp4](sequences-abstract-ad/renders/sequences-abstract-ad.mp4)                   | [source/](sequences-abstract-ad/source/)       |
