...
# + manual ffmpeg audio mux -> Showcase/chatgpt-ad/renders/final.mp4 (AAC 48kHz stereo, ffprobe-verified)
```
...
Bed: `../audio/music/confident_commercial.mp3` (0.68 gain, 0.6s fade-in, 2.2s
...
```
ffmpeg -i Showcase/chatgpt-ad/renders/silent.mp4 -i Showcase/chatgpt-ad/audio/music/confident_commercial.mp3 \
  -i Showcase/chatgpt-ad/audio/sfx/typing.wav -i Showcase/chatgpt-ad/audio/sfx/mouse_click.wav \
  -i Showcase/chatgpt-ad/audio/sfx/woosh.wav -i Showcase/chatgpt-ad/audio/sfx/notification.wav \
  ...
  Showcase/chatgpt-ad/renders/final.mp4
```
